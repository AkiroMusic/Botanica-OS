...
1−β: the probability of detecting an effect when it truly exists. A within-subject N=12 design suffices for large effects but is weak for small-to-medium ones; subgroup comparisons with 6 per cell have very low power — this is the methodological basis for labeling all of §6.6 "exploratory" (§8.1, limitation 1).
