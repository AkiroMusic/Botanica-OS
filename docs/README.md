...
This directory is the designated home for auxiliary and future materials beyond the
...
- Cite the paper by section number; state scope limits for any new empirical material.
- Code here is GPL-3.0; prose is CC-BY 4.0.
...
- 英文在前；同一文件内附中文，或以 `*.zh.md` 姊妹文件成对出现。
- 引用论文论断须标注章节号；新增实证材料须声明适用边界。
- 目录内代码遵循 GPL-3.0；文字遵循 CC-BY 4.0。
